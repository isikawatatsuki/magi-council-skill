...
```bash
node .agents/skills/magi-council/scripts/load-persona.mjs balthasar
```
...
```bash
node .agents/skills/magi-council/scripts/seal-vote.mjs --persona balthasar --stdin <<'MAGIVOTE'
{ ...your vote JSON... }
MAGIVOTE
```
