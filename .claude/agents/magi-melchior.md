...
```bash
node .agents/skills/magi-council/scripts/load-persona.mjs melchior
```
...
```bash
node .agents/skills/magi-council/scripts/seal-vote.mjs --persona melchior --stdin <<'MAGIVOTE'
{ ...your vote JSON... }
MAGIVOTE
```
